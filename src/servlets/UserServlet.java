...
public class UserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("adduser")) {
            ...
            String appodate = request.getParameter("appodate").trim();
            String appotime = request.getParameter("appotime").trim();
            int appoid = Integer.parseInt(request.getParameter("appoid"));
            int usertype = Integer.parseInt(request.getParameter("usertype"));
            UserDAO.User user = null;
            if ((user=UserDAO.createUser(username, password, fullname, appodate, appotime, appoid, usertype)) != null) {
